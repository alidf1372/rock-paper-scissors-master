...
const Scissor = () => {
    ...
    const { systemChoice } = useParams();
    return (
        <>
            <section className="result_environment">
                <div className="icon scissor_icon">
                ...
                <div className="result_content">
                    <div className="result_title">{systemChoice === 'scissor' ? (<span>DRAW</span>) : systemChoice === 'rock' ? (<span>YOU LOSE</span>) : (<span>YOU WIN</span>)}</div>
                    <button onClick={() => {navigate("/")}}>PLAY AGAIN</button>
                </div>
                {systemChoice === 'paper' ? (
                    <div className="icon paper_icon system_choice">
                    ...
                    <div className="icon scissor_icon system_choice">
                        <span>THE HOUSE PICKED</span>
                        <svg xmlns="http://www.w3.org/2000/svg" width="51" height="58">
                            <path
                                fill="#3B4262"
                    ...
                    <div className="icon rock_icon system_choice">
                        <span>THE HOUSE PICKED</span>
