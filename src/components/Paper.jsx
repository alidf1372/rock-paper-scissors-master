        ...
        <>
            <section className="result_environment">
                ...
                <div className="result_content">
                    <div className="result_title">{systemChoice === 'paper' ? (<span>DRAW</span>) : systemChoice === 'scissor' ? (<span>YOU LOSE</span>) : (<span>YOU WIN</span>)}</div>
